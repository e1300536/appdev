...
// this function will calculate one second of sound samples into eight
// pieces of slow decibel (ISO standard), this data s calculated as
// 125ms of samples the first hald of function is to calculate, the second
// half is to perform libcurl communication
